...
"""
fruta = ('manzana', 'pera', 'piña')             # la notacion de las tuplas se hace con los parentesis, diferenciandolos de listas y diccionarios
...
print(type(fruta))                              # retorna el mensaje "<class 'tuple'>" que indica el tipo de del parametro
animales = ('perro',)
print(animales)
print(type(animales))
tupla = ('Carlos', 20, True, 45.9, [3,5,2])     # puede almacenar mas de dos elementos, incluyendo listas como un elemento
print(tupla)
lista = list(tupla)                             # se pueden migrar los datos a una lista, o cambiar el tipo del parametro, esto se hace por si se requiere hacer una edición a la tupla
print(lista)
...
"""esta funcion realiza las cuatro operaciones básicas usando como valores, dos parametros dados                       

    Parámetros: a (int): valor de entrada 
                b (int): valor de entrada
    retorna:    valores (tuple): retorna un una tupla con los resultados de las operaciones realizadas con los parametros introducidos
"""
def operaciones(a,b):           
    suma = a + b
    resta = a- b
