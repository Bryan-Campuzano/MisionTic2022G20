""" esta función toma dos concatenaciones y devuelve la suma de estas.
"""
saludo1 = "hola mundo"
nombre = "Mi nombre es Bryan"
saludo2 = saludo1+" "+nombre #concatenación de variables de tipo string
print (saludo2) 

""" esta función toma dos números dados por el usuario y devuelve la suma de estos.
"""
...
""" esta función lee un numero he indica si este es mayor igual a 100.
"""
...
""" función que cuenta de 1 a 10 (ciclos tipo while).
"""  
contador=1                  #se inicializa una variable de tipo int que servirá como indice del ciclo
...
""" función que cuenta de 1 a 10 (ciclos tipo for).
""" 
...
""" esta función dice si un número entero dado e indica si este es mayor o igual a 100 reiteradas veces hasta que el usuario dictamine.
"""
respuesta = 'S'
...
""" esta función dice si un numero dado por el usuario es par o impar
"""
num=int(input ())
if num<0:
...
#NOTA SOBRE ESTA FUNCIÓN: en el segundo if, matemáticamente es un error, pues el dividir y multiplicar 
#por el mismo numero un entero, da como resultado este mismo entero. mas sin embargo, al estar num/2 dentro de
#la función int, esta lo convertirá en el entero mas proximo a la baja, cambiando el valor de los impares y 
